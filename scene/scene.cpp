...
Scene::Scene(Game *parent_game, const QRectF& rect) : QGraphicsScene(rect), game(parent_game)
{
    ...
    group_item[GROUP_NEWROUND][2] = nullptr;
    ...
    group_item[GROUP_GAMEPLAY][3] = nullptr;
    ...
    group_item[GROUP_FIRSTSCREEN][3] = nullptr;
...
// Hàm làm mờ các nhóm QGraphicsPixmapItem khi chuyển cảnh
